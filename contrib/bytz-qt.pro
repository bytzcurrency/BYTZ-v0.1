...
RESOURCES += src/qt/bytz.qrc src/qt/bytz_locale.qrc

TRANSLATIONS += src/qt/locale/bytz_bg.ts \
                src/qt/locale/bytz_de.ts \
                src/qt/locale/bytz_en.ts \
                src/qt/locale/bytz_es.ts \
                src/qt/locale/bytz_fi.ts \
                src/qt/locale/bytz_fr.ts \
                src/qt/locale/bytz_it.ts \
                src/qt/locale/bytz_ja.ts \
                src/qt/locale/bytz_pl.ts \
                src/qt/locale/bytz_pt.ts \
                src/qt/locale/bytz_ru.ts \
                src/qt/locale/bytz_sk.ts \
                src/qt/locale/bytz_sv.ts \
                src/qt/locale/bytz_vi.ts \
                src/qt/locale/bytz_zh_CN.ts \
                src/qt/locale/bytz_zh_TW.ts
