...
In order to support loading of multiple wallets in bytz-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bytz.cpp.
...
Changes to bytz.cpp
----------------------
bytz.cpp is the entry point into bytz-qt, and as such, will require some minor modifications to provide hooks for
