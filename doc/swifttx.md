...
This mechanism has been integrated into Bitcore-Node-BYTZ which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bytzcurrency/insight-api-bytz#web-socket-api](https://github.com/bytzcurrency/insight-api-bytz#web-socket-api) 
* API: [https://github.com/bytzcurrency/insight-api-bytz#swifttx-transactions](https://github.com/bytzcurrency/insight-api-bytz#swifttx-transactions) 
...
By default, the BYTZ Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BYTZ Core daemon:
