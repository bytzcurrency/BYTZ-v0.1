...
#   c) node1 mines 32 blocks, so now node 0 has 60001bytz, node 1 has 4250bytz, node2 has none.
#   d) node0 sends 601 bytz to node2, in two transactions (301 bytz, then 300 bytz).
