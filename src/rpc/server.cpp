...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BYTZ features */
        {"bytz", "masternode", &masternode, true, true, false},
        {"bytz", "listmasternodes", &listmasternodes, true, true, false},
        {"bytz", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bytz", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bytz", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bytz", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bytz", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bytz", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bytz", "masternodedebug", &masternodedebug, true, true, false},
        {"bytz", "startmasternode", &startmasternode, true, true, false},
        {"bytz", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bytz", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bytz", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bytz", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bytz", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bytz", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bytz", "mnbudget", &mnbudget, true, true, false},
        {"bytz", "preparebudget", &preparebudget, true, true, false},
        {"bytz", "submitbudget", &submitbudget, true, true, false},
        {"bytz", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bytz", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bytz", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bytz", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bytz", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bytz", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bytz", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bytz", "checkbudgets", &checkbudgets, true, true, false},
        {"bytz", "mnsync", &mnsync, true, true, false},
        {"bytz", "spork", &spork, true, true, false},
        {"bytz", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> bytz-cli " + methodname + " " + args + "\n";
}
