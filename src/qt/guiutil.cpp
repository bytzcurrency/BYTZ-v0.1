...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a BYTZ address (e.g. %1)").arg("sQXHdhcYpBHVWirqcGz78fF6p1qtNbY6y9"));
#endif
...
{
    // Convert bytz:// to bytz:
    //
    //    Cannot handle this later, because bytz:// will cause Qt to see the part after // as host,
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "BYTZ.lnk";
}
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the bytz app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add bytz app to startup item list
