                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBYTZPathCustom = GetArg("-zbytzbackuppath", "");
    ...
    if(!strzBYTZPathCustom.empty()) {
        ui->wallet_customzbytzbackuppath->setText(QString::fromStdString(strzBYTZPathCustom));
        ui->wallet_customzbytzbackuppath_label->setVisible(true);
        ui->wallet_customzbytzbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBYTZPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BYTZ RPC console.") + "<br>" +
