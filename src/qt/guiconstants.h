...
/* Bytz GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BYTZ"
#define QAPP_ORG_DOMAIN "bytz.io"
#define QAPP_APP_NAME_DEFAULT "BYTZ-Qt"
#define QAPP_APP_NAME_TESTNET "BYTZ-Qt-testnet"
