                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BYTZ Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    overviewAction = new QAction(QIcon(":/icons/overview"), tr("&BYTZ"), this);
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BYTZ address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bytz: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBYTZ"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BYTZ Core"), this);
    aboutAction->setStatusTip(tr("Show information about BYTZ Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BYTZ"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BYTZ addresses"));
    ...
    openAction->setStatusTip(tr("Open a BYTZ: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BYTZ Core help message to get a list with possible BYTZ command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BYTZ Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BYTZ network", "", count));
}
...
{
    QString strTitle = tr("BYTZ Core"); // default title
