...
QString BitcoinUnits::id(int unit)
{
    ...
    case BYTZ:
        return QString("bytz");
    case mBYTZ:
        return QString("mbytz");
    case uBYTZ:
        return QString::fromUtf8("ubytz");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        switch (unit) {
        case BYTZ:
            return QString("tBYTZ");
        case mBYTZ:
            return QString("mtBYTZ");
        case uBYTZ:
            return QString::fromUtf8("μtBYTZ");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case BYTZ:
            return QString("BYTZ");
        case mBYTZ:
            return QString("Milli-BYTZ (1 / 1" THIN_SP_UTF8 "000)");
        case uBYTZ:
            return QString("Micro-BYTZ (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case BYTZ:
            return QString("TestBYTZs");
        case mBYTZ:
            return QString("Milli-TestBYTZ (1 / 1" THIN_SP_UTF8 "000)");
        case uBYTZ:
            return QString("Micro-TestBYTZ (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
